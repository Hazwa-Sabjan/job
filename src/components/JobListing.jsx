...
const JobListing = () => {
    ...
    return (
        <div className="container 2xl:px-20 mx-auto flex flex-col md:flex-row max-md:space-y-8 py-10" >
            {/*sidebar */}
            <div className="w-full md:w-1/3 bg-white px-4">
             ...
             {/* job listings */}
                <section className="w-full md:w-3/4 max-md:px-4">
